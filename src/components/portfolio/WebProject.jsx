        ...
        <article className="bg-gray-800 p-4 rounded-3xl border border-transparent transition-all duration-300 hover:border-green-300 hover:bg-transparent">
            ...
            <div className="flex gap-4 mb-2">
                ...
                <a
                    ...
                    className={`w-max inline-block py-3 px-5 rounded-lg cursor-pointer border transition-all duration-300 ${project.disabled
                            ? 'pointer-events-none text-gray-600 border-gray-600 line-through'
                            : 'bg-green-400 text-gray-900 border-green-400 hover:bg-white hover:text-gray-900 hover:border-transparent'
                        }`}
                    target="_blank"
                    rel="noopener noreferrer"
